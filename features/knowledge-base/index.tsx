...
export default function KnowledgeManagement() {
    ...
    return (
      <div className="flex h-screen w-full items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-muted-foreground">You must be a superuser or staff member to access the Knowledgebase page.</p>
        </div>
      </div>
    );
  }
  ...
  const handleLinkFiles = useCallback((fileIds: string[], knowledgeBaseId: string) => {
  ...
  return (
    <div className="flex-1 flex flex-col h-full">
      ...
      <div className="flex-1 overflow-auto p-4">
        <Tabs defaultValue="files" value={activeTab} onValueChange={handleTabChange}>
          <TabsList>
