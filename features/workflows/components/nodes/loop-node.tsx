...
export function LoopNode({ data, id, width, height }: NodeProps) {
      ...
      <div className="p-3 space-y-2">
        <div className="flex items-center justify-between">
          <div className="bg-blue-100 rounded flex items-center justify-center gap-1 px-2 py-1">
            <Repeat size={14} className="text-blue-700" />
            <span className='text-xs font-semibold text-blue-700'>Loop</span>
          </div>
          <Button
            onClick={onDelete}
