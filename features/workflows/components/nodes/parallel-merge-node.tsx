...
export function ParallelMergeNode({ data, id, width, height }: NodeProps) {
      ...
      <div className="p-3 space-y-2">
        <div className="flex items-center justify-between">
          <div className="bg-blue-100 rounded flex items-center justify-center gap-1 px-2 py-1">
            <GitMerge size={14} className="text-blue-700" />
            <span className='text-xs font-semibold text-blue-700'>Merge</span>
          </div>
          <Button
            onClick={onDelete}
