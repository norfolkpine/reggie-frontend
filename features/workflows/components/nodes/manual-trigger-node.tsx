...
export function ManualTriggerNode({ data, id, width, height }: NodeProps) {
      ...
      <div className="p-3 space-y-2">
        <div className="flex items-center justify-between">
          <div className="bg-green-100 rounded flex items-center justify-center gap-1 px-2 py-1">
            <PlayCircle size={14} className="text-green-700" />
            <span className='text-xs font-semibold text-green-700'>Manual</span>
          </div>
          <Button
            onClick={onDelete}
