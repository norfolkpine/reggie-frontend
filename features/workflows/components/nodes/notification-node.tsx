...
export function NotificationNode({ data, id }: NodeProps) {
      ...
      <div className="p-3 space-y-2">
        <div className="flex items-center justify-between">
          <div className="bg-orange-100 rounded flex items-center justify-center gap-1 px-2 py-1">
            <Bell size={14} className="text-orange-700" />
            <span className='text-xs font-semibold text-orange-700'>Notify</span>
          </div>
          <Button
            onClick={onDelete}
