...
export function ChildWorkflowNode({ data, id }: NodeProps) {
  ...
  return (
    <div className="rounded-lg bg-gray-50 border-2 border-gray-300 shadow-sm w-[200px] relative group">
      <Handle
        type="target"
      ...
      <div className="p-3 space-y-2">
        <div className="flex items-center justify-between">
          <div className="bg-gray-100 rounded flex items-center justify-center gap-1 px-2 py-1">
            <Workflow size={14} className="text-gray-700" />
            <span className='text-xs font-semibold text-gray-700'>Child WF</span>
          </div>
          <Button
            onClick={onDelete}
