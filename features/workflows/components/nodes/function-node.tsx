...
export function FunctionNode({ data, id, width, height }: NodeProps) {
  ...
  return (
    <div 
      className="rounded-lg bg-white border-2 border-gray-200 shadow-sm relative group"
      ...
      <div className="p-3 space-y-2">
        <div className="flex items-center justify-between">
          <div className="bg-purple-100 rounded flex items-center justify-center gap-1 px-2 py-1">
            ...
            <span className='text-xs font-semibold text-purple-700'>Function</span>
          </div>
          <Button
            onClick={onDelete}
