        ...
        return (
          <div
            ...
            style={{
              ...
              width: `calc(var(--col-${cell.column.id}-size, ${COLUMN_SIZE.DEFAULT}) * 1px)`,
              minWidth: `calc(var(--col-${cell.column.id}-size, ${COLUMN_SIZE.DEFAULT}) * 1px)`,
              maxWidth: `calc(var(--col-${cell.column.id}-size, ${COLUMN_SIZE.DEFAULT}) * 1px)`,
            }}
          >
