    ...
    <div className="space-y-4 md:space-y-8 max-w-4xl mx-auto">
      ...
      >
        <div className="flex items-center justify-center gap-3 mb-2">
          ...
          <h2 className="text-xl md:text-2xl lg:text-3xl font-heading font-bold bg-gradient-to-r from-opie-purple to-opie-teal bg-clip-text text-transparent">
            {label} 🚀
          </h2>
        </div>
        <p className="text-muted-foreground text-sm md:text-base lg:text-lg font-sans">
      ...
      >
        {suggestions.map((suggestion, index) => (
          <motion.button
            ...
            className="group relative flex items-center justify-between w-full p-3 md:p-4 rounded-xl border border-opie-purple-medium bg-gradient-to-r from-opie-purple-light to-opie-teal-light hover:border-opie-purple-dark hover:shadow-md hover:shadow-opie-purple-medium transition-all duration-300 text-left min-h-[48px] md:min-h-[60px]"
          >
            <div className="flex-1 pr-4">
              <p className="text-foreground font-sans font-medium text-sm md:text-base leading-relaxed transition-colors group-hover:text-opie-purple">
                {suggestion}
              </p>
            </div>
