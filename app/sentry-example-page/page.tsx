    ...
    <div>
      ...
      <main>
        ...
        <p className="description">
          Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://ben-heath-pty-ltd.sentry.io/issues/?project=4509738327539712">Issues Page</a>.
        ...
        <button
          ...
          onClick={async () => {
            await Sentry.startSpan({
              ...
              // API route removed for static export compatibility
